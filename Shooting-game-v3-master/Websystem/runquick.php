		...
		jQuery.ajax({
            ...
            success: function(data) {
                ...
                if (fel == "true") {
					...
					$(location).attr('href','resultsquick.php')
				}
                }
            }
        });   
	...
	jQuery.ajax({
            ...
            success: function(data) {
                ...
                if (fel == "true") {
					...
					if (isdone == '1') {
					if (round == '<?php echo $rounds; ?>') {	
                    $("#resu").append('<span class="appt-block bookedClearFix approved"><span class="status-block"><i class="booked-icon booked-icon-radio-checked"></i> <?=gettext("Played");?></span><i class="booked-icon booked-icon-clock"></i><strong><?=gettext("Round");?> '+round+' <?=gettext("of");?> <?php echo $rounds;?>:</strong> '+result+' <?=gettext("secounds");?></span> ');
